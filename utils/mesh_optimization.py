...
def pointsToMesh(allLABs):
    ...
    print("1")
    # verts, faces = trimesh.remesh.subdivide_to_size(mesh.vertices, mesh.faces, 0.5)
    # return trimesh.Trimesh(vertices=verts, faces=faces)
    return mesh



    # # Assuming your point cloud is in a numpy array
    # points = allLABs  # Shape: (N, 3)
    ...
    # # Estimate normals (critical for surface reconstruction)
    ...
    # depth=9,  # Lower depth (try 6-8 instead of 9)
    # width=0,
    # scale=1.1,
    # linear_fit=False
    ...
    # # Remove low-density vertices (often creates cleaner results)
    # vertices_to_remove = densities < np.quantile(densities, 0.01)
    # mesh.remove_vertices_by_mask(vertices_to_remove)

    # # Get the mesh as numpy arrays
