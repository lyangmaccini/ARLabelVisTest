...
public class LookupTableRender : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var linesReadLAB = File.ReadLines("./Assets/AllCandidateLABvals_CIELAB_1_RGD.txt");
        ...
        AssetDatabase.CreateAsset(LookupTable, $"Assets/CIELAB_LookupTexture_05_RGD.asset");
